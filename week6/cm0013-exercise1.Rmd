...
- This is a misleading statement. It is very weak, since the data illustrates how there is no significant difference in hours worked.

- Main takeaway: It is important to critically examine the data, rather than just taking the statement at face-value. 
...
- No. Mainly because the way the graphs are laid out are misleading to the reader. They appear to portray an increase in temperature, however, if you look further, there is no increase. 

- Main takeaway: It is important to critically look at the graphs that are being presented.
...
- I'm not entirely sure why it is strong, but I believe it has to do with the fact that the plots are misleading. If you change the axes and rearrange the order, you may notice a different outcome. 
