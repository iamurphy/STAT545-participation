...
```{r}
h_countries <- c("Canada", "Brazil", "France", "Bolivia", "Russia")
gap <- gapminder %>% 
...
Section 9.6 of Jenny Bryan's [notes](https://stat545.com/factors-boss.html#reorder-factors) have some helpful examples.
...
gapminder %>%
  ggplot() +
  geom_bar(aes(fct_recode(continent, "OCN" = "Oceania", 
                          "AME" = "Americas"))) +
  coord_flip() +
  theme_bw() +
  xlab("Continent") + ylab("Number of entries")
